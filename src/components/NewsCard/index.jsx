...
const NewsCard = ({ article, isFeatured = false }) => {
  return (
    ...
    >
      ...
      >
        <img
          src={isFeatured ? (article.featuredImage || article.thumbnail || 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?auto=format&fit=crop&w=1200&q=80') : (article.thumbnail || 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?auto=format&fit=crop&w=600&q=80')}
          alt={article.title}
          onError={(e) => {
