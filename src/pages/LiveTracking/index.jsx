...
const SingleLiveUpdate = () => {
  ...
  const { data: relatedData } = useQuery({ queryKey: ['articles', { category: article?.category, limit: 5 }], queryFn: () => getArticles({ category: article?.category, limit: 5 }), enabled: !!article?.category });
...
export default SingleLiveUpdate;
