...
const PopupAd = () => {
  ...
  const [form, setForm] = useState({
    ...
    linkUrl: dbData.popupAd?.linkUrl ?? '',
  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSave} className="bg-[#18181B] rounded-2xl border border-gray-800 p-6 space-y-5">
        ...
        {[
          { label: 'Title', field: 'title', placeholder: 'e.g. New Release Alert!' },
          { label: 'Image URL', field: 'imageUrl', placeholder: 'https://...' },
          { label: 'Link URL', field: 'linkUrl', placeholder: 'https://...' },
          { label: 'Button Text', field: 'buttonText', placeholder: 'e.g. Watch Now' },
